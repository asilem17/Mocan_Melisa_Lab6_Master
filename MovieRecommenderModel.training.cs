...
namespace Mocan_Melisa_Lab6_Master
{
    public partial class MovieRecommenderModel
    {
        public const string RetrainFilePath =  @"C:\Users\Melisa\Documents\facultate\master\anul 1 sem 1\medii de programare avansate\recommendation-ratings-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"movieId",inputColumnName:@"movieId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"rating",MatrixColumnIndexColumnName=@"userId",MatrixRowIndexColumnName=@"movieId",ApproximationRank=16,LearningRate=0.3053168953697346,NumberOfIterations=212,Quiet=true}))      
